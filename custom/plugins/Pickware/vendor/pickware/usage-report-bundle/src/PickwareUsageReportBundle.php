...
namespace Pickware\UsageReportBundle;
...
class PickwareUsageReportBundle extends Bundle
{
    ...
    public function build(ContainerBuilder $containerBuilder): void
    {
        ...
        if (
            class_exists(ShopwareIntegrationTestPlugin::class)
            && in_array(ShopwareIntegrationTestPlugin::class, $containerBuilder->getParameter('kernel.bundles'), true)
        ) {
