...
use Pickware\SendcloudBundle\Installation\PickwareSendcloudBundleInstaller;
...
class PickwareSendcloudBundle extends Bundle
{
    /**
    ...
    public function install(InstallContext $installContext): void
    {
        ...
        PickwareSendcloudBundleInstaller::initFromContainer($this->container)->install();
    }
    ...
    {
        PickwareSendcloudBundleInstaller::initFromContainer($this->container)->uninstall();
