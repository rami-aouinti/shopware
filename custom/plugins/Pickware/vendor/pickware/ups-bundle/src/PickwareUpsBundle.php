...
use Pickware\UpsBundle\Installation\PickwareUpsBundleInstaller;
...
class PickwareUpsBundle extends Bundle
{
    /**
    ...
    public function install(InstallContext $installContext): void
    {
        ...
        PickwareUpsBundleInstaller::initFromContainer($this->container)->install($installContext->getContext());
    }
    ...
    {
        PickwareUpsBundleInstaller::initFromContainer($this->container)->uninstall($uninstallContext->getContext());
