...
namespace Pickware\SwissPostBundle;
...
use Pickware\SwissPostBundle\Installation\PickwareSwissPostBundleInstaller;
...
class PickwareSwissPostBundle extends Bundle
{
    /**
    ...
    public function install(InstallContext $installContext): void
    {
        ...
        PickwareSwissPostBundleInstaller::initFromContainer($this->container)->install($installContext->getContext());
    }
    ...
    {
        PickwareSwissPostBundleInstaller::initFromContainer($this->container)->uninstall($uninstallContext->getContext());
