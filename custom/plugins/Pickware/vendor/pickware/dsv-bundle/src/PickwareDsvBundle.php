...
namespace Pickware\DsvBundle;

use Pickware\BundleInstaller\BundleInstaller;
use Pickware\DalBundle\PickwareDalBundle;
use Pickware\DsvBundle\Installation\PickwareDsvBundleInstaller;
...
class PickwareDsvBundle extends Bundle
{
    /**
    ...
    public function install(InstallContext $installContext): void
    {
        ...
        PickwareDsvBundleInstaller::initFromContainer($this->container)->install();
    }
    ...
    {
        PickwareDsvBundleInstaller::initFromContainer($this->container)->uninstall();
