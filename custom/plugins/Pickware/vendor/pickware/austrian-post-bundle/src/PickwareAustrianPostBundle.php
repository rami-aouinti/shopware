...
namespace Pickware\AustrianPostBundle;

use Pickware\AustrianPostBundle\Installation\PickwareAustrianPostBundleInstaller;
...
class PickwareAustrianPostBundle extends Bundle
{
    /**
    ...
    public function install(InstallContext $installContext): void
    {
        ...
        PickwareAustrianPostBundleInstaller::initFromContainer($this->container)->install($installContext->getContext());
    }
    ...
    {
        PickwareAustrianPostBundleInstaller::initFromContainer($this->container)->uninstall($uninstallContext->getContext());
